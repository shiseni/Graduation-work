  ...
  return (
    <div className="container">
      ...
      <div className="section-body">
        <div className="files">
          <p>
            <a href="https://disk.yandex.ru/i/0MjSVq4JkQyN1g" target="_blank" rel="noreferrer">
              <img src="/images/icon_generic.gif" alt="Файл" title="Файл" />
              <span>Образец договора об оказании платных образовательных услуг</span>
            </a>
          </p>
          <p>
            <a href="https://disk.yandex.ru/i/f4VOLVQdZAPRpw" target="_blank" rel="noreferrer">
              <img src="/images/icon_generic.gif" alt="Файл" title="Файл" />
              <span>
          ...
          <p>
            <a href="/files/order_foreign_2020_2021.pdf" target="_blank" rel="noreferrer">
              <img src="/images/icon_generic.gif" alt="Файл" title="Файл" />
