          ...
          <div className="table">
            ...
            <div className="info-education-table">
              <div className="table-body">
                ...
                <span>Нормативный срок обучения</span>
                <span>Описание образовательной программы с приложением копий</span>
              </div>
              <div className="table-body">
                <span>08.02.01 Строительство и эксплуатация зданий и сооружений</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
              ...
              <div className="table-body">
                <span>08.02.01 Строительство и эксплуатация зданий и сооружений (актуализированный ФГОС)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>09.02.03 Программирование в компьютерных системах</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>09.02.07 Информационные системы и программирование</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>11.02.02 Техническое обслуживание и ремонт радиоэлектронной техники (по отраслям)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>13.02.11 Техническая эксплуатация и обслуживание электрического и электромеханического оборудования (по отраслям) </span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>13.02.11 Техническая эксплуатация и обслуживание электрического и электромеханического оборудования (по отраслям)(актуализированный ФГОС)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>21.02.03 Сооружение и эксплуатация газонефтепроводов и газонефтехранилищ</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>38.02.01 Экономика и бухгалтерский учет (по отраслям)(актуализированный ФГОС)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>38.02.04 Коммерция (по отраслям)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>38.02.07 Банковское дело</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
              ...
              <div className="table-body">
                <span>38.02.07 Банковское дело (актуализированный ФГОС)</span>
                <span>очная</span>
                <span>
                  <p>базовая подготовка:</p>
                  <p>3 года 10 месяцев</p>
